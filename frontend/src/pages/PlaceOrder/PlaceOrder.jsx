...
const PlaceOrder = () => {
  ...
  const placeOrder = async (event) => {
    ...
    const orderData = {
      address: data,
      items: orderItems,
      amount: getTotalCartAmount() + 50, // Add delivery fee
    };
    ...
    try {
      ...
      if (response.data.success) {
        ...
        navigate('/myorders'); // Navigate to 'My Orders' page after successful order
        alert('Order placed successfully!');
      } else {
        // Log detailed error message to help debug the issue
